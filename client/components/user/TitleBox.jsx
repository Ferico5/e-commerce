const TitleBox = ({ first, second, size }) => {
  const baseClasses =
    "flex justify-center items-center text-[#707070] mb-2 gap-2";
  ...
  if (size === "big") {
    ...
    return (
      <div
        className="flex items-center font-medium text-base sm:text-lg md:text-xl text-[#707070] mb-10 gap-2"
      >
        <p>
    ...
    return (
      <div
        className="flex justify-center items-center font-medium text-lg sm:text-xl md:text-2xl text-[#707070] mb-13 gap-2"
      >
        <p>
          {first} <span className="text-[#171717] font-[470]">{second}</span>
        </p>
