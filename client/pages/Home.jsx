...
const Home = () => {
    ...
    useEffect(()=>{
        const getLastCollection = products.sort((a,b)=>b.date - a.date)
        .slice(0,10)
        setLastCollectionList(getLastCollection)
    }, [])

    useEffect(()=>{
        const getBestSeller = products.filter(p => p.bestseller === true)
        .slice(0,5)
    ...
    return (
        <div className='content'>
            ...
            <div className='py-8'>
                <div className='items-center flex justify-center my-10 flex-col leading-10'>
                    <h1 className='text-[29px] font-[500] text-gray-700'><span className='text-gray-500'>BEST</span> SELLERS</h1>
                    <p className='text-[14px] '>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the.</p>
                </div>
