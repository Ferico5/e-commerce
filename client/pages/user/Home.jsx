  ...
  return (
    <ResponsiveContainer className="pt-9">
      ...
      <div className="flex flex-col sm:flex-row pt-10 pb-10 gap-10 place-content-evenly">
        <div className="w-full flex flex-col items-center justify-center">
          <img src={assets.exchange_icon} alt="Exchange Icon" loading="lazy" className="w-10 m-4" />
        ...
        <div className="w-full flex flex-col items-center justify-center">
          <img src={assets.quality_icon} alt="Quality Icon" loading="lazy" className="w-10 m-4" />
        ...
        <div className="w-full flex flex-col items-center justify-center">
          <img src={assets.support_img} alt="Support Image" loading="lazy" className="w-10 m-4" />
