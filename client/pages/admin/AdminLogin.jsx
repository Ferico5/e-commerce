  ...
  return (
    <div className="flex justify-center items-center h-[100vh] bg-[#F9FAFB]">
      <div
        ...
        style={{
          boxShadow:
            "0 0 0 rgba(0, 0, 0, 0), -1px 0 1px rgba(0, 0, 0, 0.1), 0 4px 4px rgba(0, 0, 0, 0.15)",
        }}
      >
        ...
        <form onSubmit={handleLogin} className="flex flex-col mt-4">
          ...
          <label
            htmlFor="email"
            className="text-[#515661] font-semibold text-sm mb-1"
          >
            Email Address
          </label>
          <input
            ...
            className="w-70 px-3 py-2 mt-1 rounded-md border border-gray-600 focus:outline-none mb-3"
            required
            autoComplete="off"
          />
          ...
          <input
            ...
            className="w-70 px-3 py-2 mt-1 rounded-md border border-gray-600 focus:outline-none"
            required
            autoComplete="off"
          />

          {/* Button */}
          <button className="px-3 py-2 rounded-md bg-black text-white mt-5 hover:cursor-pointer">
            Login
          </button>
        </form>
      </div>
